/* THIS IS SP_ NI404 */
/* Sadly, this project isnt continued anymore in this format.*/
/* This code compiles and works as a great start for adventures in sound, but is far from completion */
/* BUT: This is Open-Source-MIT-licensed Software - make it better and contribute! */
/**/
/* Feel free to check out its successor project toern (http://github.com/Soundpauli/toern) */
...
void checkPositions() {
  for (unsigned int i = 0; i < 4; i++) {
    ...
    if (currentEncoderValue != previousEncoderValues[i]) {
     ...
     // not finally implemented: FILTERS
